...
package stegmpp.crypto;


import java.util.Arrays;

/**
 * The Rabbit class is used to encrypt and decrypt data using the Rabbit stream cypher.
 * This code is taken from {@link https://gist.github.com/Chase-san/2814851} by Chase-san.
 * 
 * Tested against the actual RFC {@link http://tools.ietf.org/rfc/rfc4503.txt}.
 * 
...
public class Rabbit
{
	...
	/**
	 * The main method in this class is used to test the Rabbit cypher implementation.
	 * @param args
	 */
	public static void main(String [] args)
	{
		
		byte[] key={1,2,3,4,5,6,7,8,9,0,11,12,13,14,15,16};
		String text="Test Rabbit Cypher";
		...
		byte[] decrypted=rabbit1.crypt(ct);
